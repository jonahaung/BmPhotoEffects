...
enum AIModelError: String, Error {
...
final class AIModel {
    ...
    let queue = DispatchQueue(label: Constants.Queue.label)
    ...
    private struct Constants {
        ...
        struct Queue {
            static let label = "com.jonahaung.CartoonGan.serial"
        }
    }
    ...
    func start(name: String, ext: String) {
        queue.async {
            guard let modelPath = Bundle.main.path(
                ...
                print("Could not find model file: \(name).\(ext)")
            ...
            do {
                ...
                print("Interpreter initialization failed with error: \(error.localizedDescription)")
                self.delegate?.model(self, didFinishAllocation: .allocation)
                return
            }
    ...
    func process(_ image: UIImage) {
        ...
        queue.async {
            ...
            do {
                ...
                print("Processing failed with error: \(error.localizedDescription)")
